...
foreach ($categories as $categorie):
    ...
    if ($categorie['id'] == '1'): ?>
	     ...
	     <div class="tab-pane show active" id = "<?php echo "a '. $categorie[id] .' "; ?> "role = "tabpanel">


	      <?php else: ?>
      <div class = "tab-pane" id = "<?php echo "a' . $categorie[id] . '"; ?> "role = "tabpanel">
...
while ($item = $statement->fetch()):
    ...
    ?>
	        ...
	        <div class="card col-sm-6 col-12 col-lg-4"  style="width: 18rem;  margin-top: 20px;">
	                ...
	                <!-- <img src="upload/'. $item['image'].'" class="card-img-top" alt="..."> -->
...
?>
    ...
    <!-- <div class="py-5" style="min-height: 30%; margin-bottom: -50px;"></div> -->
    <?php
